...
package local_project.fidelite_0_1;
 ...
 * @status
 */
public class Fidelite implements TalendJob {
	...
	private final String jobName = "Fidelite";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Fidelite.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mainStruct implements routines.system.IPersistableRow<mainStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Fidelite = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Fidelite = new byte[0];
		...
		public String fidel_libelle;

		public String getFidel_libelle() {
			return this.fidel_libelle;
		}
		...
		public void copyDataTo(mainStruct other) {
			...
			other.fidel_libelle = this.fidel_libelle;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_Fidelite.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_Fidelite.length == 0) {
						commonByteArray_LOCAL_PROJECT_Fidelite = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_Fidelite = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_Fidelite, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_Fidelite, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_Fidelite) {
				...
				try {
					...
					this.fidel_libelle = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.fidel_libelle, dos);
		...
		public String toString() {
			...
			sb.append(",fidel_libelle=" + fidel_libelle);
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("fidelite");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("fidelite");
				}
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/DEV/Data/Base Montauban/param/fidelités.csv";
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.CODE_FIDELITE = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 1;

							row1.LIBELLE_FIDELITE = fid_tFileInputDelimited_1
...
// # Output table : 'main'
								main_tmp.idfidel = Integer.parseInt(row1.CODE_FIDELITE);
								main_tmp.fidel_libelle = row1.LIBELLE_FIDELITE;
								main = main_tmp;
// ###############################
...
// Start of branch "main"
							if (main != null) {
								...
								pstmt_tDBOutput_1.setInt(1, main.idfidel);

								if (main.fidel_libelle == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, main.fidel_libelle);
								}
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:i/ZiJh4w9dkXtKsQWzcZ4fpww6Ery0pmWqHHqVZEJlBT6pCqAg==");
	...
	public static void main(String[] args) {
		final Fidelite FideliteClass = new Fidelite();

		int exitCode = FideliteClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Fidelite.class.getClassLoader()
					.getResourceAsStream("local_project/fidelite_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Fidelite.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Fidelite");
		}
...
/************************************************************************************************
 * 72562 characters generated by Talend Open Studio for Data Integration on the
 * 22 novembre 2021 à 15:13:50 CET
 ************************************************************************************************/