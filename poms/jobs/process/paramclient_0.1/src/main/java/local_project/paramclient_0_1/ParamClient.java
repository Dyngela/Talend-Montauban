...
package local_project.paramclient_0_1;
 ...
 * @status
 */
public class ParamClient implements TalendJob {
	...
	private final String jobName = "ParamClient";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ParamClient.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mainStruct implements routines.system.IPersistableRow<mainStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_ParamClient = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_ParamClient = new byte[0];
		...
		public BigDecimal paramclient_nombre_facture;

		public BigDecimal getParamclient_nombre_facture() {
			return this.paramclient_nombre_facture;
		}

		public BigDecimal paramclient_nb_bon_liv;

		public BigDecimal getParamclient_nb_bon_liv() {
			return this.paramclient_nb_bon_liv;
		}

		public Boolean paramclient_internet;

		public Boolean getParamclient_internet() {
			return this.paramclient_internet;
		}

		public Boolean paramclient_gestion_fidelite;

		public Boolean getParamclient_gestion_fidelite() {
			return this.paramclient_gestion_fidelite;
		}

		public Boolean paramclient_envoie_facture_mail;

		public Boolean getParamclient_envoie_facture_mail() {
			return this.paramclient_envoie_facture_mail;
		}

		public Boolean paramclient_envoie_bl_mail;

		public Boolean getParamclient_envoie_bl_mail() {
			return this.paramclient_envoie_bl_mail;
		}

		public Boolean paramclient_envoie_facture_web;

		public Boolean getParamclient_envoie_facture_web() {
			return this.paramclient_envoie_facture_web;
		}

		public Boolean paramclient_envoie_bl_web;

		public Boolean getParamclient_envoie_bl_web() {
			return this.paramclient_envoie_bl_web;
		}

		public Boolean paramclient_publipostage;

		public Boolean getParamclient_publipostage() {
			return this.paramclient_publipostage;
		}

		public Boolean paramclient_facture_edi;

		public Boolean getParamclient_facture_edi() {
			return this.paramclient_facture_edi;
		}

		public Boolean paramclient_facture_chorus;

		public Boolean getParamclient_facture_chorus() {
			return this.paramclient_facture_chorus;
		}

		public Boolean paramclient_affacturage;

		public Boolean getParamclient_affacturage() {
			return this.paramclient_affacturage;
		}

		public Boolean paramclient_affichage;

		public Boolean getParamclient_affichage() {
			return this.paramclient_affichage;
		}

		public Boolean paramclient_prix_net;

		public Boolean getParamclient_prix_net() {
			return this.paramclient_prix_net;
		}

		public Boolean paramclient_facturation_releve;

		public Boolean getParamclient_facturation_releve() {
			return this.paramclient_facturation_releve;
		}

		public Boolean paramclient_gestion_reliquat;

		public Boolean getParamclient_gestion_reliquat() {
			return this.paramclient_gestion_reliquat;
		}

		public BigDecimal paramclient_coef_majo_factu;

		public BigDecimal getParamclient_coef_majo_factu() {
			return this.paramclient_coef_majo_factu;
		}

		public Boolean paramclient_controle_cde;

		public Boolean getParamclient_controle_cde() {
			return this.paramclient_controle_cde;
		}

		public Boolean paramclient_edition_pn_remise;

		public Boolean getParamclient_edition_pn_remise() {
			return this.paramclient_edition_pn_remise;
		}

		public String paramclient_bl_chiffre_en_total;

		public String getParamclient_bl_chiffre_en_total() {
			return this.paramclient_bl_chiffre_en_total;
		}

		public String paramclient_bl_chiffre_en_ligne;

		public String getParamclient_bl_chiffre_en_ligne() {
			return this.paramclient_bl_chiffre_en_ligne;
		}

		public String paramclient_chorus_service;

		public String getParamclient_chorus_service() {
			return this.paramclient_chorus_service;
		}
		...
		public void copyDataTo(mainStruct other) {
			...
			other.paramclient_nombre_facture = this.paramclient_nombre_facture;
			other.paramclient_nb_bon_liv = this.paramclient_nb_bon_liv;
			other.paramclient_internet = this.paramclient_internet;
			other.paramclient_gestion_fidelite = this.paramclient_gestion_fidelite;
			other.paramclient_envoie_facture_mail = this.paramclient_envoie_facture_mail;
			other.paramclient_envoie_bl_mail = this.paramclient_envoie_bl_mail;
			other.paramclient_envoie_facture_web = this.paramclient_envoie_facture_web;
			other.paramclient_envoie_bl_web = this.paramclient_envoie_bl_web;
			other.paramclient_publipostage = this.paramclient_publipostage;
			other.paramclient_facture_edi = this.paramclient_facture_edi;
			other.paramclient_facture_chorus = this.paramclient_facture_chorus;
			other.paramclient_affacturage = this.paramclient_affacturage;
			other.paramclient_affichage = this.paramclient_affichage;
			other.paramclient_prix_net = this.paramclient_prix_net;
			other.paramclient_facturation_releve = this.paramclient_facturation_releve;
			other.paramclient_gestion_reliquat = this.paramclient_gestion_reliquat;
			other.paramclient_coef_majo_factu = this.paramclient_coef_majo_factu;
			other.paramclient_controle_cde = this.paramclient_controle_cde;
			other.paramclient_edition_pn_remise = this.paramclient_edition_pn_remise;
			other.paramclient_bl_chiffre_en_total = this.paramclient_bl_chiffre_en_total;
			other.paramclient_bl_chiffre_en_ligne = this.paramclient_bl_chiffre_en_ligne;
			other.paramclient_chorus_service = this.paramclient_chorus_service;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_ParamClient.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_ParamClient.length == 0) {
						commonByteArray_LOCAL_PROJECT_ParamClient = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_ParamClient = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_ParamClient, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_ParamClient, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_ParamClient) {
				...
				try {
					...
					this.paramclient_nombre_facture = (BigDecimal) dis.readObject();

					this.paramclient_nb_bon_liv = (BigDecimal) dis.readObject();

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_internet = null;
					} else {
						this.paramclient_internet = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_gestion_fidelite = null;
					} else {
						this.paramclient_gestion_fidelite = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_envoie_facture_mail = null;
					} else {
						this.paramclient_envoie_facture_mail = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_envoie_bl_mail = null;
					} else {
						this.paramclient_envoie_bl_mail = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_envoie_facture_web = null;
					} else {
						this.paramclient_envoie_facture_web = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_envoie_bl_web = null;
					} else {
						this.paramclient_envoie_bl_web = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_publipostage = null;
					} else {
						this.paramclient_publipostage = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_facture_edi = null;
					} else {
						this.paramclient_facture_edi = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_facture_chorus = null;
					} else {
						this.paramclient_facture_chorus = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_affacturage = null;
					} else {
						this.paramclient_affacturage = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_affichage = null;
					} else {
						this.paramclient_affichage = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_prix_net = null;
					} else {
						this.paramclient_prix_net = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_facturation_releve = null;
					} else {
						this.paramclient_facturation_releve = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_gestion_reliquat = null;
					} else {
						this.paramclient_gestion_reliquat = dis.readBoolean();
					}

					this.paramclient_coef_majo_factu = (BigDecimal) dis.readObject();

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_controle_cde = null;
					} else {
						this.paramclient_controle_cde = dis.readBoolean();
					}

					length = dis.readByte();
					if (length == -1) {
						this.paramclient_edition_pn_remise = null;
					} else {
						this.paramclient_edition_pn_remise = dis.readBoolean();
					}

					this.paramclient_bl_chiffre_en_total = readString(dis);

					this.paramclient_bl_chiffre_en_ligne = readString(dis);

					this.paramclient_chorus_service = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeObject(this.paramclient_nombre_facture);

				// BigDecimal

				dos.writeObject(this.paramclient_nb_bon_liv);

				// Boolean

				if (this.paramclient_internet == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_internet);
				}

				// Boolean

				if (this.paramclient_gestion_fidelite == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_gestion_fidelite);
				}

				// Boolean

				if (this.paramclient_envoie_facture_mail == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_envoie_facture_mail);
				}

				// Boolean

				if (this.paramclient_envoie_bl_mail == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_envoie_bl_mail);
				}

				// Boolean

				if (this.paramclient_envoie_facture_web == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_envoie_facture_web);
				}

				// Boolean

				if (this.paramclient_envoie_bl_web == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_envoie_bl_web);
				}

				// Boolean

				if (this.paramclient_publipostage == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_publipostage);
				}

				// Boolean

				if (this.paramclient_facture_edi == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_facture_edi);
				}

				// Boolean

				if (this.paramclient_facture_chorus == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_facture_chorus);
				}

				// Boolean

				if (this.paramclient_affacturage == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_affacturage);
				}

				// Boolean

				if (this.paramclient_affichage == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_affichage);
				}

				// Boolean

				if (this.paramclient_prix_net == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_prix_net);
				}

				// Boolean

				if (this.paramclient_facturation_releve == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_facturation_releve);
				}

				// Boolean

				if (this.paramclient_gestion_reliquat == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_gestion_reliquat);
				}

				// BigDecimal

				dos.writeObject(this.paramclient_coef_majo_factu);

				// Boolean

				if (this.paramclient_controle_cde == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_controle_cde);
				}

				// Boolean

				if (this.paramclient_edition_pn_remise == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeBoolean(this.paramclient_edition_pn_remise);
				}

				// String

				writeString(this.paramclient_bl_chiffre_en_total, dos);

				// String

				writeString(this.paramclient_bl_chiffre_en_ligne, dos);

				// String

				writeString(this.paramclient_chorus_service, dos);
		...
		public String toString() {
			...
			sb.append(",paramclient_nombre_facture=" + String.valueOf(paramclient_nombre_facture));
			sb.append(",paramclient_nb_bon_liv=" + String.valueOf(paramclient_nb_bon_liv));
			sb.append(",paramclient_internet=" + String.valueOf(paramclient_internet));
			sb.append(",paramclient_gestion_fidelite=" + String.valueOf(paramclient_gestion_fidelite));
			sb.append(",paramclient_envoie_facture_mail=" + String.valueOf(paramclient_envoie_facture_mail));
			sb.append(",paramclient_envoie_bl_mail=" + String.valueOf(paramclient_envoie_bl_mail));
			sb.append(",paramclient_envoie_facture_web=" + String.valueOf(paramclient_envoie_facture_web));
			sb.append(",paramclient_envoie_bl_web=" + String.valueOf(paramclient_envoie_bl_web));
			sb.append(",paramclient_publipostage=" + String.valueOf(paramclient_publipostage));
			sb.append(",paramclient_facture_edi=" + String.valueOf(paramclient_facture_edi));
			sb.append(",paramclient_facture_chorus=" + String.valueOf(paramclient_facture_chorus));
			sb.append(",paramclient_affacturage=" + String.valueOf(paramclient_affacturage));
			sb.append(",paramclient_affichage=" + String.valueOf(paramclient_affichage));
			sb.append(",paramclient_prix_net=" + String.valueOf(paramclient_prix_net));
			sb.append(",paramclient_facturation_releve=" + String.valueOf(paramclient_facturation_releve));
			sb.append(",paramclient_gestion_reliquat=" + String.valueOf(paramclient_gestion_reliquat));
			sb.append(",paramclient_coef_majo_factu=" + String.valueOf(paramclient_coef_majo_factu));
			sb.append(",paramclient_controle_cde=" + String.valueOf(paramclient_controle_cde));
			sb.append(",paramclient_edition_pn_remise=" + String.valueOf(paramclient_edition_pn_remise));
			sb.append(",paramclient_bl_chiffre_en_total=" + paramclient_bl_chiffre_en_total);
			sb.append(",paramclient_bl_chiffre_en_ligne=" + paramclient_bl_chiffre_en_ligne);
			sb.append(",paramclient_chorus_service=" + paramclient_chorus_service);
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("paramclient");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("paramclient");
				}
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"idparamclient\",\"paramclient_nombre_facture\",\"paramclient_nb_bon_liv\",\"paramclient_internet\",\"paramclient_gestion_fidelite\",\"paramclient_envoie_facture_mail\",\"paramclient_envoie_bl_mail\",\"paramclient_envoie_facture_web\",\"paramclient_envoie_bl_web\",\"paramclient_publipostage\",\"paramclient_facture_edi\",\"paramclient_facture_chorus\",\"paramclient_affacturage\",\"paramclient_affichage\",\"paramclient_prix_net\",\"paramclient_facturation_releve\",\"paramclient_gestion_reliquat\",\"paramclient_coef_majo_factu\",\"paramclient_controle_cde\",\"paramclient_edition_pn_remise\",\"paramclient_bl_chiffre_en_total\",\"paramclient_bl_chiffre_en_ligne\",\"paramclient_chorus_service\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// # Output table : 'main'
								main_tmp.idparamclient = Numeric.sequence("s1", 1, 1);
								main_tmp.paramclient_nombre_facture = null;
								main_tmp.paramclient_nb_bon_liv = null;
								main_tmp.paramclient_internet = row1.CINTERNET.equals("N") ? false
										: row1.CINTERNET.equals("O") ? true : false;
								main_tmp.paramclient_gestion_fidelite = row1.CTAR.equals("N") ? false
										: row1.CTAR.equals("O") ? true : false;
								main_tmp.paramclient_envoie_facture_mail = row1.CFACTMAIL.equals("N") ? false
										: row1.CFACTMAIL.equals("O") ? true : false;
								main_tmp.paramclient_envoie_bl_mail = row1.CBLMAIL.equals("N") ? false
										: row1.CBLMAIL.equals("O") ? true : false;
								main_tmp.paramclient_envoie_facture_web = row1.CFACTWEB.equals("N") ? false
										: row1.CFACTWEB.equals("O") ? true : false;
								main_tmp.paramclient_envoie_bl_web = row1.CBLWEB.equals("N") ? false
										: row1.CBLWEB.equals("O") ? true : false;
								main_tmp.paramclient_publipostage = row1.CPUBLIPOSTAGE.equals("N") ? false
										: row1.CPUBLIPOSTAGE.equals("O") ? true : false;
								main_tmp.paramclient_facture_edi = row1.CFACT_EDI.equals("N") ? false
										: row1.CFACT_EDI.equals("O") ? true : false;
								main_tmp.paramclient_facture_chorus = row1.CFACT_CHORUS.equals("N") ? false
										: row1.CFACT_CHORUS.equals("O") ? true : false;
								main_tmp.paramclient_affacturage = row1.CFACTORING.equals("N") ? false
										: row1.CFACTORING.equals("O") ? true : false;
								main_tmp.paramclient_affichage = row1.CAFFMEMO.equals("N") ? false
										: row1.CAFFMEMO.equals("O") ? true : false;
								main_tmp.paramclient_prix_net = row1.CPNAFF.equals("N") ? false
										: row1.CPNAFF.equals("O") ? true : false;
								main_tmp.paramclient_facturation_releve = row1.CRELEVE.equals("N") ? false
										: row1.CRELEVE.equals("O") ? true : false;
								main_tmp.paramclient_gestion_reliquat = row1.CRELIQ.equals("N") ? false
										: row1.CRELIQ.equals("O") ? true : false;
								main_tmp.paramclient_coef_majo_factu = new BigDecimal(row1.CCOEF);
								main_tmp.paramclient_controle_cde = row1.CCONTR.equals("N") ? false
										: row1.CCONTR.equals("O") ? true : false;
								main_tmp.paramclient_edition_pn_remise = row1.CEPNASR.equals("N") ? false
										: row1.CEPNASR.equals("O") ? true : false;
								main_tmp.paramclient_bl_chiffre_en_total = row1.CBLTOT;
								main_tmp.paramclient_bl_chiffre_en_ligne = row1.CBLLIG;
								main_tmp.paramclient_chorus_service = row1.CCHORUS_SERVICE;
								main = main_tmp;
// ###############################
...
// Start of branch "main"
							if (main != null) {
								...
								pstmt_tDBOutput_1.setInt(1, main.idparamclient);

								pstmt_tDBOutput_1.setBigDecimal(2, main.paramclient_nombre_facture);

								pstmt_tDBOutput_1.setBigDecimal(3, main.paramclient_nb_bon_liv);

								if (main.paramclient_internet == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(4, main.paramclient_internet);
								}

								if (main.paramclient_gestion_fidelite == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(5, main.paramclient_gestion_fidelite);
								}

								if (main.paramclient_envoie_facture_mail == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(6, main.paramclient_envoie_facture_mail);
								}

								if (main.paramclient_envoie_bl_mail == null) {
									pstmt_tDBOutput_1.setNull(7, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(7, main.paramclient_envoie_bl_mail);
								}

								if (main.paramclient_envoie_facture_web == null) {
									pstmt_tDBOutput_1.setNull(8, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(8, main.paramclient_envoie_facture_web);
								}

								if (main.paramclient_envoie_bl_web == null) {
									pstmt_tDBOutput_1.setNull(9, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(9, main.paramclient_envoie_bl_web);
								}

								if (main.paramclient_publipostage == null) {
									pstmt_tDBOutput_1.setNull(10, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(10, main.paramclient_publipostage);
								}

								if (main.paramclient_facture_edi == null) {
									pstmt_tDBOutput_1.setNull(11, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(11, main.paramclient_facture_edi);
								}

								if (main.paramclient_facture_chorus == null) {
									pstmt_tDBOutput_1.setNull(12, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(12, main.paramclient_facture_chorus);
								}

								if (main.paramclient_affacturage == null) {
									pstmt_tDBOutput_1.setNull(13, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(13, main.paramclient_affacturage);
								}

								if (main.paramclient_affichage == null) {
									pstmt_tDBOutput_1.setNull(14, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(14, main.paramclient_affichage);
								}

								if (main.paramclient_prix_net == null) {
									pstmt_tDBOutput_1.setNull(15, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(15, main.paramclient_prix_net);
								}

								if (main.paramclient_facturation_releve == null) {
									pstmt_tDBOutput_1.setNull(16, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(16, main.paramclient_facturation_releve);
								}

								if (main.paramclient_gestion_reliquat == null) {
									pstmt_tDBOutput_1.setNull(17, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(17, main.paramclient_gestion_reliquat);
								}

								pstmt_tDBOutput_1.setBigDecimal(18, main.paramclient_coef_majo_factu);

								if (main.paramclient_controle_cde == null) {
									pstmt_tDBOutput_1.setNull(19, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(19, main.paramclient_controle_cde);
								}

								if (main.paramclient_edition_pn_remise == null) {
									pstmt_tDBOutput_1.setNull(20, java.sql.Types.BOOLEAN);
								} else {
									pstmt_tDBOutput_1.setBoolean(20, main.paramclient_edition_pn_remise);
								}

								if (main.paramclient_bl_chiffre_en_total == null) {
									pstmt_tDBOutput_1.setNull(21, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(21, main.paramclient_bl_chiffre_en_total);
								}

								if (main.paramclient_bl_chiffre_en_ligne == null) {
									pstmt_tDBOutput_1.setNull(22, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(22, main.paramclient_bl_chiffre_en_ligne);
								}

								if (main.paramclient_chorus_service == null) {
									pstmt_tDBOutput_1.setNull(23, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(23, main.paramclient_chorus_service);
								}
...
// ###############################      
	...
	public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBConnection_1 = "jdbc:postgresql://" + "192.168.1.110" + ":" + "5432" + "/" + "syg-test";
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:7sIN9nSJIbjr4U6QOIivT/N9xES9iVd9leW5BNBOlUnRuTGocQ==");
	...
	public static void main(String[] args) {
		final ParamClient ParamClientClass = new ParamClient();

		int exitCode = ParamClientClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ParamClient.class.getClassLoader()
					.getResourceAsStream("local_project/paramclient_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ParamClient.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ParamClient");
		}
...
/************************************************************************************************
 * 149625 characters generated by Talend Open Studio for Data Integration on the
 * 24 novembre 2021 à 15:05:24 CET
 ************************************************************************************************/