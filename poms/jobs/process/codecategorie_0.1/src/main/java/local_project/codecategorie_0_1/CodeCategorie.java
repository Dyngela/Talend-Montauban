...
package local_project.codecategorie_0_1;
 ...
 * @status
 */
public class CodeCategorie implements TalendJob {
	...
	private final String jobName = "CodeCategorie";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					CodeCategorie.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CodeCategorie.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mainStruct implements routines.system.IPersistableRow<mainStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_CodeCategorie = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_CodeCategorie = new byte[0];
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.cat_id == null) ? 0 : this.cat_id.hashCode());
		...
		public boolean equals(Object obj) {
			...
			} else if (!this.cat_id.equals(other.cat_id))
		...
		public void copyDataTo(mainStruct other) {
			...
			other.cat_id = this.cat_id;
			other.cat_libelle = this.cat_libelle;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_CodeCategorie.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_CodeCategorie.length == 0) {
						commonByteArray_LOCAL_PROJECT_CodeCategorie = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_CodeCategorie = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_CodeCategorie, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_CodeCategorie, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_CodeCategorie) {

				try {

					int length = 0;

					this.cat_id = readString(dis);

					this.cat_libelle = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.cat_id, dos);

				// String

				writeString(this.cat_libelle, dos);
		...
		public String toString() {
			...
			sb.append(",cat_libelle=" + cat_libelle);
			sb.append("]");
		...
		public int compareTo(mainStruct other) {
			...
			returnValue = checkNullsAndCompare(this.cat_id, other.cat_id);
			if (returnValue != 0) {
				return returnValue;
			}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("codecategorie");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("codecategorie");
				}
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/DEV/Data/Base Montauban/param/categories.csv";
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.CODE_CATEGORIE = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 1;

							row1.LIBELLE_CATEGORIE = fid_tFileInputDelimited_1
...
// # Output table : 'main'
								main_tmp.cat_id = row1.CODE_CATEGORIE;
								main_tmp.cat_libelle = row1.LIBELLE_CATEGORIE;
								main = main_tmp;
// ###############################
...
// Start of branch "main"
							if (main != null) {
								...
								if (main.cat_id == null) {
									...
									pstmt_tDBOutput_1.setString(1, main.cat_id);
								}

								if (main.cat_libelle == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, main.cat_libelle);
								}
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:9vMnccd5/eWENtmDm5B/QOiPlGRxyDDI2o4IzBIe9hI/qRDj/A==");
	...
	public static void main(String[] args) {
		final CodeCategorie CodeCategorieClass = new CodeCategorie();

		int exitCode = CodeCategorieClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CodeCategorie.class.getClassLoader()
					.getResourceAsStream("local_project/codecategorie_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CodeCategorie.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CodeCategorie");
		}
...
/************************************************************************************************
 * 72922 characters generated by Talend Open Studio for Data Integration on the
 * 22 novembre 2021 à 15:52:32 CET
 ************************************************************************************************/