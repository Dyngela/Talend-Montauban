...
package local_project.qualite_0_1;
 ...
 * @status
 */
public class Qualite implements TalendJob {
	...
	private final String jobName = "Qualite";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Qualite.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class mainStruct implements routines.system.IPersistableRow<mainStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_Qualite = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_Qualite = new byte[0];
		...
		public String qual_libelle;

		public String getQual_libelle() {
			return this.qual_libelle;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.qual_id == null) ? 0 : this.qual_id.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.qual_id == null) {
				if (other.qual_id != null)
					return false;

			} else if (!this.qual_id.equals(other.qual_id))
		...
		public void copyDataTo(mainStruct other) {
			...
			other.qual_id = this.qual_id;
			other.qual_libelle = this.qual_libelle;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_Qualite.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_Qualite.length == 0) {
						commonByteArray_LOCAL_PROJECT_Qualite = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_Qualite = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_Qualite, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_Qualite, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_Qualite) {

				try {

					int length = 0;

					this.qual_id = readString(dis);

					this.qual_libelle = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.qual_id, dos);

				// String

				writeString(this.qual_libelle, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("qual_id=" + qual_id);
			sb.append(",qual_libelle=" + qual_libelle);
			sb.append("]");
		...
		public int compareTo(mainStruct other) {
			...
			returnValue = checkNullsAndCompare(this.qual_id, other.qual_id);
			if (returnValue != 0) {
				return returnValue;
			}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("qualite");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("qualite");
				}
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_2 = "C:/DEV/Data/Base Montauban/param/qualités.csv";
					...
					while (fid_tFileInputDelimited_2 != null && fid_tFileInputDelimited_2.nextRecord()) {
						...
						try {
							...
							row1.CODE_QUALITE = fid_tFileInputDelimited_2.get(columnIndexWithD_tFileInputDelimited_2);

							columnIndexWithD_tFileInputDelimited_2 = 1;

							row1.LIBELLE_QUALITE = fid_tFileInputDelimited_2
...
// # Output table : 'main'
								main_tmp.qual_id = row1.CODE_QUALITE;
								main_tmp.qual_libelle = row1.LIBELLE_QUALITE;
								main = main_tmp;
// ###############################
...
// Start of branch "main"
							if (main != null) {
								...
								if (main.qual_id == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(1, main.qual_id);
								}

								if (main.qual_libelle == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, main.qual_libelle);
								}
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:RU/fTV5kMoB9DEdg7r3Oaj6A7sMBKl3653ZNNumLKhojLtxfXw==");
	...
	public static void main(String[] args) {
		final Qualite QualiteClass = new Qualite();

		int exitCode = QualiteClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Qualite.class.getClassLoader()
					.getResourceAsStream("local_project/qualite_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Qualite.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Qualite");
		}
...
/************************************************************************************************
 * 72712 characters generated by Talend Open Studio for Data Integration on the
 * 22 novembre 2021 à 11:23:47 CET
 ************************************************************************************************/