...
package local_project.modepayement_0_1;
 ...
 * @status
 */
public class ModePayement implements TalendJob {
	...
	private final String jobName = "ModePayement";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ModePayement.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:HtLTktXFfqi7Bv5giLyxmo75rY/PCuX+pRqTx6h3YGeP0ydcKA==");
	...
	public static class mainStruct implements routines.system.IPersistableRow<mainStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_ModePayement = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_ModePayement = new byte[0];
		...
		public String modepayement_id;

		public String getModepayement_id() {
			return this.modepayement_id;
		}

		public String modepayement_libelle;

		public String getModepayement_libelle() {
			return this.modepayement_libelle;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.modepayement_id == null) ? 0 : this.modepayement_id.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.modepayement_id == null) {
				if (other.modepayement_id != null)
					return false;

			} else if (!this.modepayement_id.equals(other.modepayement_id))
		...
		public void copyDataTo(mainStruct other) {
			...
			other.modepayement_id = this.modepayement_id;
			other.modepayement_libelle = this.modepayement_libelle;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_ModePayement.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_ModePayement.length == 0) {
						commonByteArray_LOCAL_PROJECT_ModePayement = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_ModePayement = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_ModePayement, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_ModePayement, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_ModePayement) {

				try {

					int length = 0;

					this.modepayement_id = readString(dis);

					this.modepayement_libelle = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.modepayement_id, dos);

				// String

				writeString(this.modepayement_libelle, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("modepayement_id=" + modepayement_id);
			sb.append(",modepayement_libelle=" + modepayement_libelle);
			sb.append("]");
		...
		public int compareTo(mainStruct other) {
			...
			returnValue = checkNullsAndCompare(this.modepayement_id, other.modepayement_id);
			if (returnValue != 0) {
				return returnValue;
			}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("modepayement");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("modepayement");
				}
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"modepayement_id\",\"modepayement_libelle\") VALUES (?,?)";
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/DEV/Data/Base Montauban/param/paiement.csv";
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.CODE_PAIEMENT = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 1;

							row1.LIBELLE_PAIEMENT = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 2;

							row1.DETAIL_PAIEMENT = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 3;

							row1.JOURNAL_PAIEMENT = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 4;

							row1.COMPTE_PAIEMENT = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 5;

							row1.TRAITE_PAIEMENT = fid_tFileInputDelimited_1
									.get(columnIndexWithD_tFileInputDelimited_1);
...
// # Output table : 'main'
								main_tmp.modepayement_id = row1.CODE_PAIEMENT;
								main_tmp.modepayement_libelle = row1.LIBELLE_PAIEMENT;
								main = main_tmp;
// ###############################
...
// Start of branch "main"
							if (main != null) {
								...
								if (main.modepayement_id == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(1, main.modepayement_id);
								}

								if (main.modepayement_libelle == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, main.modepayement_libelle);
								}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final ModePayement ModePayementClass = new ModePayement();

		int exitCode = ModePayementClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ModePayement.class.getClassLoader()
					.getResourceAsStream("local_project/modepayement_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ModePayement.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ModePayement");
		}
...
/************************************************************************************************
 * 78657 characters generated by Talend Open Studio for Data Integration on the
 * 22 novembre 2021 à 15:54:35 CET
 ************************************************************************************************/