...
package local_project.codesecteur_0_1;
 ...
 * @status
 */
public class CodeSecteur implements TalendJob {
	...
	private final String jobName = "CodeSecteur";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CodeSecteur.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:2pA0qTZVg2CcYNlP7Bw4QnUgrUAKBNTW/0xLhxJ9edCRP7rH6g==");
	...
	public static class mainStruct implements routines.system.IPersistableRow<mainStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_CodeSecteur = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_CodeSecteur = new byte[0];
		...
		public String sect_libelle;

		public String getSect_libelle() {
			return this.sect_libelle;
		}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.sect_id == null) ? 0 : this.sect_id.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.sect_id == null) {
				if (other.sect_id != null)
					return false;

			} else if (!this.sect_id.equals(other.sect_id))
		...
		public void copyDataTo(mainStruct other) {
			...
			other.sect_id = this.sect_id;
			other.sect_libelle = this.sect_libelle;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_CodeSecteur.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_CodeSecteur.length == 0) {
						commonByteArray_LOCAL_PROJECT_CodeSecteur = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_CodeSecteur = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_CodeSecteur, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_CodeSecteur, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_CodeSecteur) {

				try {

					int length = 0;

					this.sect_id = readString(dis);

					this.sect_libelle = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.sect_id, dos);

				// String

				writeString(this.sect_libelle, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("sect_id=" + sect_id);
			sb.append(",sect_libelle=" + sect_libelle);
			sb.append("]");
		...
		public int compareTo(mainStruct other) {
			...
			returnValue = checkNullsAndCompare(this.sect_id, other.sect_id);
			if (returnValue != 0) {
				return returnValue;
			}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("codesecteur");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("codesecteur");
				}
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = "C:/DEV/Data/Shema/Secteur.xml";
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								"C:/DEV/Data/Shema/Secteur.xml", "ISO-8859-15", ";", "\n", true, 1, 0,
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.CODE_SECTEUR = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 1;

							row1.LIBELLE_SECTEUR = fid_tFileInputDelimited_1
...
// # Output table : 'main'
								main_tmp.sect_id = row1.CODE_SECTEUR;
								main_tmp.sect_libelle = row1.LIBELLE_SECTEUR;
								main = main_tmp;
// ###############################
...
// Start of branch "main"
							if (main != null) {
								...
								if (main.sect_id == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(1, main.sect_id);
								}

								if (main.sect_libelle == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, main.sect_libelle);
								}
					...
					if (!((Object) ("C:/DEV/Data/Shema/Secteur.xml") instanceof java.io.InputStream)) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final CodeSecteur CodeSecteurClass = new CodeSecteur();

		int exitCode = CodeSecteurClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CodeSecteur.class.getClassLoader()
					.getResourceAsStream("local_project/codesecteur_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CodeSecteur.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CodeSecteur");
		}
...
/************************************************************************************************
 * 76324 characters generated by Talend Open Studio for Data Integration on the
 * 22 novembre 2021 à 15:16:26 CET
 ************************************************************************************************/