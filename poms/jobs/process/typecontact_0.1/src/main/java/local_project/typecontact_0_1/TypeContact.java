...
package local_project.typecontact_0_1;
 ...
 * @status
 */
public class TypeContact implements TalendJob {
	...
	private final String jobName = "TypeContact";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(TypeContact.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:C4AYACl0b22+eZGeNtvWmedsd2y+synIkJKNVGTd2uPuEFIfSg==");
	...
	public static class mainStruct implements routines.system.IPersistableRow<mainStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_TypeContact = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_TypeContact = new byte[0];
		...
		public java.util.Date typcon_date_premier_contact;

		public java.util.Date getTypcon_date_premier_contact() {
			return this.typcon_date_premier_contact;
		}

		public java.util.Date typcon_date_dernier_contact;

		public java.util.Date getTypcon_date_dernier_contact() {
			return this.typcon_date_dernier_contact;
		}

		public java.util.Date typcon_date_prochain_contact;

		public java.util.Date getTypcon_date_prochain_contact() {
			return this.typcon_date_prochain_contact;
		}
		...
		public void copyDataTo(mainStruct other) {
			...
			other.typcon_date_premier_contact = this.typcon_date_premier_contact;
			other.typcon_date_dernier_contact = this.typcon_date_dernier_contact;
			other.typcon_date_prochain_contact = this.typcon_date_prochain_contact;
			other.idtypcon = this.idtypcon;
			other.cli_id = this.cli_id;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_TypeContact.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_TypeContact.length == 0) {
						commonByteArray_LOCAL_PROJECT_TypeContact = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_TypeContact = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_TypeContact, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_TypeContact, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_TypeContact) {

				try {

					int length = 0;

					this.typcon_date_premier_contact = readDate(dis);

					this.typcon_date_dernier_contact = readDate(dis);

					this.typcon_date_prochain_contact = readDate(dis);

					this.idtypcon = dis.readInt();

					this.cli_id = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeDate(this.typcon_date_premier_contact, dos);

				// java.util.Date

				writeDate(this.typcon_date_dernier_contact, dos);

				// java.util.Date

				writeDate(this.typcon_date_prochain_contact, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("typcon_date_premier_contact=" + String.valueOf(typcon_date_premier_contact));
			sb.append(",typcon_date_dernier_contact=" + String.valueOf(typcon_date_dernier_contact));
			sb.append(",typcon_date_prochain_contact=" + String.valueOf(typcon_date_prochain_contact));
			sb.append(",idtypcon=" + String.valueOf(idtypcon));
			sb.append(",cli_id=" + cli_id);
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("typecontact");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("typecontact");
				}
				...
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"typcon_date_premier_contact\",\"typcon_date_dernier_contact\",\"typcon_date_prochain_contact\",\"idtypcon\",\"cli_id\") VALUES (?,?,?,?,?)";
...
// # Output table : 'main'
								main_tmp.typcon_date_premier_contact = null;
								main_tmp.typcon_date_dernier_contact = null;
								main_tmp.typcon_date_prochain_contact = null;
								main_tmp.idtypcon = Numeric.sequence("s1", 1, 1);
								main_tmp.cli_id = row1.CREF;
								main = main_tmp;
// ###############################
...
// Start of branch "main"
							if (main != null) {
								...
								if (main.typcon_date_premier_contact != null) {
									pstmt_tDBOutput_1.setTimestamp(1,
											new java.sql.Timestamp(main.typcon_date_premier_contact.getTime()));
								} else {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.TIMESTAMP);
								}

								if (main.typcon_date_dernier_contact != null) {
									pstmt_tDBOutput_1.setTimestamp(2,
											new java.sql.Timestamp(main.typcon_date_dernier_contact.getTime()));
								} else {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.TIMESTAMP);
								}

								if (main.typcon_date_prochain_contact != null) {
									pstmt_tDBOutput_1.setTimestamp(3,
											new java.sql.Timestamp(main.typcon_date_prochain_contact.getTime()));
								} else {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
								}

								pstmt_tDBOutput_1.setInt(4, main.idtypcon);

								if (main.cli_id == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, main.cli_id);
								}
	...
	public void tLogRow_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "typcon_date_premier_contact", "typcon_date_dernier_contact",
						"typcon_date_prochain_contact", "idtypcon", "cli_id", });
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final TypeContact TypeContactClass = new TypeContact();

		int exitCode = TypeContactClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = TypeContact.class.getClassLoader()
					.getResourceAsStream("local_project/typecontact_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = TypeContact.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TypeContact");
		}
...
/************************************************************************************************
 * 138602 characters generated by Talend Open Studio for Data Integration on the
 * 24 novembre 2021 à 16:25:39 CET
 ************************************************************************************************/